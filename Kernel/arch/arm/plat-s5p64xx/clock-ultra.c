...
u32 s5p_cpu_clk_tab[][10] = {
        { CONFIG_S5P_FREQ_BUS * 7 * MHZ,         CONFIG_S5P_FREQ_BUS*MHZ, (CONFIG_S5P_FREQ_BUS*MHZ)/2, CONFIG_S5P_FREQ_BUS*MHZ, 6, 0, 0, 1, 0, 1}, //0x828c0301
        { CONFIG_S5P_FREQ_BUS * 6 * MHZ,         CONFIG_S5P_FREQ_BUS*MHZ, (CONFIG_S5P_FREQ_BUS*MHZ)/2, CONFIG_S5P_FREQ_BUS*MHZ, 5, 0, 0, 1, 0, 1}, // 0xc1f50301
        { CONFIG_S5P_FREQ_BUS * 5 * MHZ,         CONFIG_S5P_FREQ_BUS*MHZ, (CONFIG_S5P_FREQ_BUS*MHZ)/2, CONFIG_S5P_FREQ_BUS*MHZ, 4, 0, 0, 1, 0, 1},
        { CONFIG_S5P_FREQ_BUS * 4 * MHZ,         CONFIG_S5P_FREQ_BUS*MHZ, (CONFIG_S5P_FREQ_BUS*MHZ)/2, CONFIG_S5P_FREQ_BUS*MHZ, 3, 0, 0, 1, 0, 1},
        { CONFIG_S5P_FREQ_BUS * 3 * MHZ,         CONFIG_S5P_FREQ_BUS*MHZ, (CONFIG_S5P_FREQ_BUS*MHZ)/2, CONFIG_S5P_FREQ_BUS*MHZ, 2, 0, 0, 1, 0, 1},
        { CONFIG_S5P_FREQ_BUS * 2 * MHZ,         CONFIG_S5P_FREQ_BUS*MHZ, (CONFIG_S5P_FREQ_BUS*MHZ)/2, CONFIG_S5P_FREQ_BUS*MHZ, 1, 0, 0, 1, 0, 1},
        { CONFIG_S5P_FREQ_BUS * 1 * MHZ,         CONFIG_S5P_FREQ_BUS*MHZ, (CONFIG_S5P_FREQ_BUS*MHZ)/2, CONFIG_S5P_FREQ_BUS*MHZ, 1, 1, 0, 1, 0, 1},
};


u32 s5p_cpu_pll_tab[] = {
((1 << 31) | (7 * (CONFIG_S5P_FREQ_BUS/2) << 16) | (3 << 8) | 1), 
((1 << 31) | (6 * (CONFIG_S5P_FREQ_BUS/2) << 16) | (3 << 8) | 1), 
((1 << 31) | (5 * (CONFIG_S5P_FREQ_BUS/2) << 16) | (3 << 8) | 1), 
((1 << 31) | (4 * (CONFIG_S5P_FREQ_BUS/2) << 16) | (3 << 8) | 1), 
((1 << 31) | (3 * (CONFIG_S5P_FREQ_BUS/2) << 16) | (3 << 8) | 1), 
((1 << 31) | (2 * (CONFIG_S5P_FREQ_BUS/2) << 16) | (3 << 8) | 1), 
((1 << 31) | (2 * (CONFIG_S5P_FREQ_BUS/2) << 16) | (3 << 8) | 1),
}; 
...
{
	u32 size;
	size = ARRAY_SIZE(s5p_cpu_clk_tab);
...
unsigned long s5p_fclk_round_rate(struct clk *clk, unsigned long rate)
{
	...
	for(iter = 1 ; iter < size ; iter++) {
		if(rate > s5p_cpu_clk_tab[iter][0])
			return s5p_cpu_clk_tab[iter-1][0];
	}
...
#ifdef MUXD0D1_A2M
	mask = (~S5P_CLKDIV0_APLL_MASK) & (~S5P_CLKDIV0_D0CLK_MASK) & (~S5P_CLKDIV0_P0CLK_MASK) & (~S5P_CLKDIV0_D1CLK_MASK) & (~S5P_CLKDIV0_P1CLK_MASK) & (~S5P_CLKDIV0_A2M_MASK);
#else
