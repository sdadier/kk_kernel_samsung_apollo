...
u32 s5p_cpu_clk_tab[][10] = {
        {1200*MHZ,         166*MHZ, (166*MHZ)/2, 166*MHZ, 0, 0, 0, 1, 0, 1}, // 0xc1f50301
        {1000*MHZ,         166*MHZ, (166*MHZ)/2, 166*MHZ, 0, 0, 0, 1, 0, 1},
        {800*MHZ,         166*MHZ, (166*MHZ)/2, 166*MHZ, 0, 0, 0, 1, 0, 1},
        {600*MHZ,         166*MHZ, (166*MHZ)/2, 166*MHZ, 0, 0, 0, 1, 0, 1},
        {400*MHZ,         166*MHZ, (166*MHZ)/2, 166*MHZ, 0, 0, 0, 1, 0, 1},
        {200*MHZ,         166*MHZ, (166*MHZ)/2, 166*MHZ, 0, 0, 0, 1, 0, 1},
};
