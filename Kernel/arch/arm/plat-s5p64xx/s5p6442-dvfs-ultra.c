...
//        {0, 1400*KHZ_T},
        {0, 7 * CONFIG_S5P_FREQ_BUS *KHZ_T},
        {1, 6 * CONFIG_S5P_FREQ_BUS *KHZ_T},
        {2, 5 * CONFIG_S5P_FREQ_BUS *KHZ_T},
        {3, 4 * CONFIG_S5P_FREQ_BUS *KHZ_T},
        {4, 3 * CONFIG_S5P_FREQ_BUS *KHZ_T},
        {5, 2 * CONFIG_S5P_FREQ_BUS *KHZ_T},
        {6, 1 * CONFIG_S5P_FREQ_BUS *KHZ_T},
        {7, CPUFREQ_TABLE_END},
};
...
//        {1400000, 1525, 1500, 0},  // 1500
        { 7 * CONFIG_S5P_FREQ_BUS *KHZ_T, 1525, 1200, 0},  // 1500
        { 6 * CONFIG_S5P_FREQ_BUS *KHZ_T, 1350, 1200, 1}, //1350
        { 5 * CONFIG_S5P_FREQ_BUS *KHZ_T, 1275, 1200, 2},
        { 4 * CONFIG_S5P_FREQ_BUS *KHZ_T, 1200, 1200, 3},
        { 3 * CONFIG_S5P_FREQ_BUS *KHZ_T, 1150, 1200, 4},
        { 2 * CONFIG_S5P_FREQ_BUS *KHZ_T, 1100, 1200, 5},
        { 1 * CONFIG_S5P_FREQ_BUS *KHZ_T, 1100, 1200, 6},
};
