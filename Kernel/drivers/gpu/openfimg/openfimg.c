...
static int __init g3d_probe(struct platform_device *pdev)
{
	...
	/* get device clock */
	printk("G3D: probe clock");
	g3d->clock = clk_get(&pdev->dev, "hclk_g3d");
	if (g3d->clock == NULL) {
